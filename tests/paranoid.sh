...
IMG=${IMG:-arubislander/armhf-openvpn}
...
docker run --net=none --rm -t -i -v $PWD:/etc/openvpn -e "EASYRSA_BATCH=1" -e "EASYRSA_REQ_CN=Travis-CI Test CA" arubislander/armhf-openvpn ovpn_initpki nopass
